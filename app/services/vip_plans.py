...
VIP_BENEFITS = (
    "Розширена аналітика за 90, 180 і 365 днів прямо у групах",
    "Порівняння періодів та CSV/PDF-експорт біля статистики",
    "Преміальні теми звітів у налаштуваннях групи",
    "Пʼять закріплених досягнень у профілі",
    "Персональний підсумок «Мій рік у ChatPulse»",
    "Пʼять днів захисту серії на місяць замість трьох",
